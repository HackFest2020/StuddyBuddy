...
class KumustahanChatScreen extends StatefulWidget {
  KumustahanChatScreen({Key key, this.title}) : super(key: key);

  final String title; //chat_messages
  final store = FirebaseFirestore.instance.collection('kumustahan_messages');

  @override
  _KumustahanChatScreen createState() => _KumustahanChatScreen();
}

class _KumustahanChatScreen extends State<KumustahanChatScreen> {
